{ lib, symlinkJoin, makeWrapper, fcitx5, fcitx5-lua, fcitx5-configtool, fcitx5-qt,
  fcitx5-gtk, coreutils, which, gnugrep, kdialog, gettext, dbus, xprop, xdg-utils,
  systemsettings,
  addons ? [], kcmSupport ? true }:
