{ config, pkgs, lib, ... }: {
  ...
  programs.ssh = {
    ...
    knownHosts = {
      ...
      "[tsukuba.niwase.net]:49224".publicKey = "ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBF9L6WVElJnpK7zRmZdk7aYJc0z4zrZcXd0AjkqMPBnpXGL6V3pIGdDl1fRuGeeHGCif958fLcpOSzU+v2g5uEI=";
