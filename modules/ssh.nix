...
in
{
  programs.ssh = {
    ...
    knownHosts = {
      ...
      "rednecked.v.f2l.cc".publicKey = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAILPl2FFAlSd2EMv+Cx6Floei91AmTUix119a7Npm3axF";
    };
  };
}
